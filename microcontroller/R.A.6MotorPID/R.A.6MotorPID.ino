...
float RAD2DEGbase = 57.29577951308232;
float RAD2DEG = 57.29577951308232;
float RAD2DEGROT = 57.29577951308232 * 2;
float M3RAD2DEG = 57.29577951308232;


//
void joint_arm(const sensor_msgs::JointState& cmd_msg){
  base_motor1 = degreeToTicksbase(RAD2DEGbase*cmd_msg.position[0]);
  ...
  gripper_motor6 = degreeToTicksGripper(RAD2DEGROT*cmd_msg.position[5]);
}
