...
if("TRUE" STREQUAL "TRUE")
  set(myworkcell_core_SOURCE_PREFIX /home/ros-industrial/scorbot1/src/myworkcell_core)
  set(myworkcell_core_DEVEL_PREFIX /home/ros-industrial/scorbot1/devel)
  ...
  set(myworkcell_core_INSTALL_PREFIX /home/ros-industrial/scorbot1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'myworkcell_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros-industrial/scorbot1/src/myworkcell_core/${idir}'.  Ask the maintainer 'ros-industrial <ros-industrial@todo.todo>' to fix it.")
    endif()
