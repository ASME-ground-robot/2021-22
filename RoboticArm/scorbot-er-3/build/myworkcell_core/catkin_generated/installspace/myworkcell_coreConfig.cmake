...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'myworkcell_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros-industrial/scorbot1/install/${idir}'.  Ask the maintainer 'ros-industrial <ros-industrial@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ros-industrial/scorbot1/install/lib;/home/ros-industrial/scorbot1/devel/lib;/opt/ros/kinetic/lib)
